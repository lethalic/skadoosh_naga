...
public class GenerateGraphView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseAccess datacountM = DatabaseAccess.getInstance(GenerateGraphView.this); //count the names
        datacountM.open();
        ...
        for (int i=0; i<temp.length;i++)
        {
            ...
            //Toast.makeText(GenerateGraphView.this,dft,Toast.LENGTH_LONG).show();
