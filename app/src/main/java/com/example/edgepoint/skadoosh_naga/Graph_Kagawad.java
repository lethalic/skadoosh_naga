...
public class Graph_Kagawad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView date_tv = (TextView) findViewById(R.id.kdate_id);

        TextView connection_tv = (TextView) findViewById(R.id.kconnection_id);
...
//        barChart = (BarChart) findViewById(R.id.bargraph);
        ...
        HbarChart = (HorizontalBarChart) findViewById(R.id.hbargraph);

        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(this);
        databaseAccess.open();
        ArrayList<BarEntry> barEntries = databaseAccess.getBarEntries(tableGraph);
        ...
        //HbarChart.setExtraBottomOffset(20);
        // HbarChart.setViewPortOffsets(5, 0, 5, 20);
        ...
        HbarChart.setVisibleXRange(16f, 16f); // sets the viewport to show 3 bars
        HbarChart.setExtraOffsets(0, 0, 50, 0);

        DatabaseAccess datacountM = DatabaseAccess.getInstance(Graph_Kagawad.this); //count the names
        datacountM.open();
